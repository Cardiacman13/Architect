...
function install_useful_packages() {
    ...
    yay -S --needed --noconfirm gstreamer gst-plugins-bad gst-plugins-base gst-plugins-ugly gst-plugin-pipewire gstreamer-vaapi gst-plugins-good gst-libav sof-firmware fwupd xdg-utils reflector-simple downgrade rebuild-detector mkinitcpio-firmware xdg-desktop-portal neofetch power-profiles-daemon hunspell hunspell-fr p7zip unrar ttf-liberation noto-fonts-emoji-flags ntfs-3g fuse2 fuse2fs fuse3 exfat-utils bash-completion xdg-desktop-portal-gtk ffmpegthumbs vlc >> /dev/null 2>&1
